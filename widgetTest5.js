...
function ajax(){
    ...
    const obj = {affiliateId: affId};
    const affiliateId = new Blob([JSON.stringify(obj)], {type : 'application/json'});

    var formData = new FormData();

        formData.append('affiliateId', affId);
    ...
    xhttp.open("POST", 'http://www.g1gdev.com/verify-affiliate-id', true);
